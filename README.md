...
define command {
    ...
    command_line /usr/bin/printf "$LONGSERVICEOUTPUT$" | /path/to/script/notify-ms-teams.py  "$NOTIFICATIONTYPE$: $HOSTALIAS$/$SERVICEDESC$ is $SERVICESTATE$" "$SERVICEOUTPUT$" $_CONTACTWEBHOOKURL$
}
```
